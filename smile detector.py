# -*- coding: utf-8 -*-
"""
Created on Fri Oct 27 20:46:57 2017
...
def detect(gray, frame):
    ...
    for (x,y,w,h) in faces:
        ...
        eyes = eye_cascade.detectMultiScale(roi_gray, 1.1 , 22)#detecting the eyes in the face
        for (ex,ey,ew,eh) in eyes:
            cv2.rectangle(roi_color, (ex,ey),(ex+ew,ey+eh), (255,0,0),2)
        smiles = smile_cascade.detectMultiScale(roi_gray, 1.7 , 22)#detecting the smile in the face
